...
# Overview
This [https://projects.fivethirtyeight.com/non-voters-poll-2020-election/] (article from FiveThirtyEight) explores reasons that many Americans choose not to vote in elections. The reasons include:
...
```{r}
filename <- "https://raw.githubusercontent.com/fivethirtyeight/data/master/non-voters/nonvoters_data.csv"
